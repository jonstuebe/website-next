...
export function Card({
  ...
  return (
    <div
      className={
        "rounded-md bg-gray-200 dark:bg-gray-800 md:h-64 sm:h-80 h-64 border border-solid dark:border-gray-700 border-gray-300 hover:shadow-sm motion-safe:transition motion-safe:transform hover:scale-105 hover:ring-1 ring-opacity-50 ring-inset ring-blue-400 overflow-hidden relative flex items-center justify-center" +
        " " +
        className
      }
    >
